...
$hostingUnitObject = Get-Item $hostingUnitPath
...
$networkPaths = (Get-ChildItem $availabilityZonePath | Where-Object ObjectType -eq "Network") | Select-Object -ExpandProperty FullPath # will select all the networks in the availability zone
