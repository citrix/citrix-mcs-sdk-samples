<#
.SYNOPSIS
    Creates a Persistent MCS catalog. Applicable for Citrix DaaS and on-prem.
.DESCRIPTION
    Create-ProvScheme-Persistent creates a Persistent MCS ProvisioningScheme and Broker Catalog.
    The original version of this script is compatible with Citrix DaaS October 2025 Release (DDC 126).
#>
