...
.DESCRIPTION
    Remove-ImageVersionShare.ps1 removes a sharesd image version from the specified Hosting Unit.
...
Remove-ProvImageVersionSpecHostingUnit -ImageVersionSpecUid $ImageVersionSpecUid -HostingUnitName $HostingUnitName
