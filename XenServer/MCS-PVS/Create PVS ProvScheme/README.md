# Create PVS Catalogs using MCS for XenServer

This repository contains example PowerShell scripts and documentation for creating **Citrix Provisioning (PVS)**-backed Machine Catalogs on **XenServer**.

The scripts automate creation of:

- A **PVS Provisioning Scheme** (`New-ProvScheme`) for XenServer-hosted target VMs.
