...
<#
.SYNOPSIS
    Removes a PVS machine catalog including all VMs, AD accounts, and the provisioning scheme on XenServer.

.DESCRIPTION
    Remove-PvsProvScheme.ps1 performs a complete teardown of a PVS-backed MCS catalog on XenServer:
