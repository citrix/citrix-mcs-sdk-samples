...
.DESCRIPTION
    Update-MachineProfile-VMSource.ps1 helps change the MachineProfile configuration on an existing VirtualMachine in a MCS catalog.
...
## Note - To use VirtualMachine as a source for machine profile
...
# Update the MachineProfile parameter to point to a VirtualMachine source
