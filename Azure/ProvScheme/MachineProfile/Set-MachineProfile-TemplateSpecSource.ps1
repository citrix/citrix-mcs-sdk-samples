...
.DESCRIPTION
    Set-MachineProfile-TemplateSpecSource.ps1 helps change the MachineProfile configuration on an existing MCS catalog.
...
$updateMachineProfile = "XDHyp:\HostingUnits\$hostingUnitName\machineprofile.folder\$resourceGroupName.resourcegroup\$templateSpecName.templatespec\$templateSpecVersion.templatespecversion"
