...
###############################################################
Get-ProvVmHardwareUpdate -MaintenanceCycleId $maintenanceCycleId -ProvisioningSchemeName $provisioningSchemeName -ProvisioningSchemeUid $provisioningSchemeUid
```
