...
.SYNOPSIS
	...
	For applying to existing machines, run Set-ProvVmUpdateTimeWindow and restart the machines. Applicable for Citrix DaaS and on-prem.
.DESCRIPTION
    This script changes the MachineProfile configuration on an existing MCS catalog.
    In this example, the MachineProfile parameter is updated to a VM 'vm-name' on the ProvScheme 'demo-provScheme'.
...
$machineProfileVmName = "vm-name"

# Update the MachineProfile parameter to point to a VM source
$updateMachineProfile = "XDHyp:\HostingUnits\$hostingUnitName\$machineProfileVmName.vm"
