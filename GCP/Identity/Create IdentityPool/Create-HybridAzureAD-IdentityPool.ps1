<#
.SYNOPSIS
    Creates a Hybrid AzureAD Identity Pool. Applicable for Citrix DaaS and on-prem.
.DESCRIPTION
    Create-HybridAzureAD-IdentityPool.ps1 emulates the behavior of the New-AcctIdentityPool command.
...
# Setup value to be HybridAzureAD to support Hybrid Azure AD case.
