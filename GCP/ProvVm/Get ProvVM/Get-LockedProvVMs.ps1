...
.DESCRIPTION
    Get-LockedProvVMs.ps1 emulates the behavior of the Get-ProvVM command.
...
######################################################################################################
# Get all locked Virtual Machines, regardless of which Provisioning Scheme the VM was created with. #
######################################################################################################
