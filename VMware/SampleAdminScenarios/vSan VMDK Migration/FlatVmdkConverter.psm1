...
Import-Module .\vSphereHelper.psm1
        ...
        function ConvertVmdkFiles() {
            <#
            .SYNOPSIS
            Converts the FLAT format disk to stream optimized format
            .DESCRIPTION
        ...
        # *************************************************************************/
            ...
            try {
                ...
                if ($prompt -ne "Y" -and $prompt -ne "y") {
					Write-Information -InformationAction Continue "Operation cancelled"
					return 0
				}


                if ($PSBoundParameters.ContainsKey('ProvisioningSchemeName')) {
                # read total number of mahcines from the catalog
    ...
    function ConvertVmdk() {
        ...
        try {
            ...
            # temp folder path from env and append VM name to foler path
    ...
    function RollBackIdentityDiskConversion{
        		<#  
                .SYNOPSIS
                Rolls back the identity disk conversion
                .DESCRIPTION
                This function rolls back the identity disk conversion
                .PARAMETER VMName
					The name of a virtual machine
                    .PARAMETER CloudCustomerId
                    The customer id
                ...
                try {
                        ...
                        elseif ($PSBoundParameters.ContainsKey('VMName')) {
                            ...
                            # detach  identity disk atatched during the migration
                            ...
                            # disk name is combination of VM name and string identity disk
