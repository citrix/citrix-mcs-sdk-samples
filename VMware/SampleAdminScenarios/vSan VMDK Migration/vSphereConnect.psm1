...
$global:VMwareSessionId = $null
 ...
 [string] $VMwareSessionId
    function ConnectToVMware() {
        ...
        The address of the vSphere server to establish a connection with.
        .PARAMETER UserName
        The user name to use when connecting to the vSphere server.
        .PARAMETER Password
        The password to use when connecting to the vSphere server.
        .EXAMPLE
    ...
    function DisconnectFromVMware() {
      <#
        ...
        .DESCRIPTION
        .PARAMETER ServerAddress
        The address of the vSphere server from which to disconnect.
        .EXAMPLE
