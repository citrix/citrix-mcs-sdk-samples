...
.INPUTS
    ...
    9. VMCpuCount: Number of vCPUs.
    10. VMMemoryMB: Memory size in MB.
    11. InitialBatchSizeHint: The number of initial VMs that will be added to the MCS catalog.
    12. Scope: Administration scopes for the identity pool.
    13. CleanOnBoot: Reset VMs to initial state on start.
    14. AdminAddress: The primary DDC address.
    15. UseFullDiskCloneProvisioning: This flag enables the use of Full Clone provisioning.
    16. UseWriteBackCache: A flag to enable the Write-Back Cache feature. This should be set to True to enable the Write-Back Cache.
    17. WriteBackCacheDiskSize: Specifies the disk size of the Write-Back Cache.
    18. WriteBackCacheMemorySize: Defines the memory size of the Write-Back Cache.
    19. WriteBackCacheDriveLetter: Assigns the drive letter for the Write-Back Cache disk.
#>
