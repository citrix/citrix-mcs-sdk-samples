# Remove PVS Catalog (Including VMs) on VMware

This folder contains an example PowerShell script for **completely removing** a PVS-backed MCS catalog on **VMware**, including all provisioned VMs, AD computer accounts, and associated Citrix objects.
...
### Full removal (deletes VMs from VMware)
