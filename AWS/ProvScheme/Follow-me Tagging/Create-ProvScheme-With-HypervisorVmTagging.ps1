<#
.SYNOPSIS
    Creates an MCS catalog with Follow-me Tagging enabled. Applicable for Citrix DaaS.
.DESCRIPTION
    Create-ProvScheme-With-HypervisorVmTagging creates an MCS ProvisioningScheme and Broker Catalog.
