...
$connection = New-Item -Path $connectionPath -ConnectionType "AWS" -HypervisorAddress "https://ec2.$($cloudRegion).amazonaws.com" -CustomProperties $customProperties -Persist -Scope @() -UserName $apiKey -SecurePassword $securePassword -ZoneUid $zoneUid
