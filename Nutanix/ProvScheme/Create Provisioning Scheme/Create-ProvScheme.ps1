...
.INPUTS
    ...
    6. CustomProperties: Used to provide Container Path(as hypervisor path), vCPU count, Memory, and CPUCores(Cores per CPU) values
    7. MasterImageVM: Path to VM snapshot or template
    8. VMCpuCount: Number of vCPUs
    9. VMMemoryMB: VM memory in MB
